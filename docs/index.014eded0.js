...
var prevImg = function() {
    ...
    } else carrouselWrap.style.transform = 'translateY(-' + counter * carrouselWidth + "px)";
};
...
for(let i1 = 0; i1 < randomArticle.length; i1++){
    randomArticle[i1].addEventListener('click', function() {
        randomFig[i1].classList.add('scaled');
        randomFigText[i1].classList.add('tracking-in-contract');
        cross.classList.add('is-active');
    });
    cross.addEventListener('click', function() {
        randomFig[i1].classList.remove('scaled');
        randomFigText[i1].classList.remove('tracking-in-contract');
...
for(let i2 = 0; i2 < districtPath.length; i2++)districtPath[i2].addEventListener('mouseover', function() {
    var districtID = districtPath[i2].getAttribute('id');
...
//# sourceMappingURL=index.014eded0.js.map
